...
class menuframe(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.graenseværdier = tk.Button(self.menu_frame, text="Grænser", font=("Arial", 15), command=lambda: controller.show_frame("Graensevaerdierframe"))
        self.graenseværdier.place(x=200, y=30, width=100, heigh=40)

        self.puls_graf_knap = tk.Button(self.menu_frame, text="Puls graf", font=("Arial", 15), command=lambda: controller.show_frame("pulsgrafframe"))
        self.puls_graf_knap.place(x=450, y=30, width=100, heigh=40)

        self.puls_data_knap = tk.Button(self.menu_frame, text="Puls data", font=("Arial", 15), command=lambda: controller.show_frame("pulsdataframe"))
        self.puls_data_knap.place(x=600, y=30, width=100, heigh=40)

        self.SpO2_graf_knap = tk.Button(self.menu_frame, text="SpO2 graf", font=("Arial", 15), command=lambda: controller.show_frame("SpO2grafframe"))
        self.SpO2_graf_knap.place(x=850, y=30, width=100, heigh=40)

        self.SpO2_data_knap = tk.Button(self.menu_frame, text="SpO2 data", font=("Arial", 15), command=lambda: controller.show_frame("SpO2dataframe"))
        self.SpO2_data_knap.place(x=1000, y=30, width=100, heigh=40)

        self.forside_knap = tk.Button(self.menu_frame, text="Forside", font=("Arial", 15), command=lambda: controller.show_frame("forsideframe"))
...
class Graensevaerdierframe(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.minEw_entry = tk.Entry(self.frame1, textvariable= self.minEw)
        ...
        self.maxEw_entry = tk.Entry(self.frame1, textvariable= self.maxEw)
        ...
        self.minKri_entry = tk.Entry(self.frame1, textvariable=self.minKri)
        ...
        self.maxKri_entry = tk.Entry(self.frame1, textvariable=self.maxKri)
        ...
        self.ewIlt_entry = tk.Entry(self.frame2, textvariable=self.ewIlt, )
        ...
        self.kriIlt_entry = tk.Entry(self.frame2, textvariable=self.kriIlt)
        ...
        # enter button
        self.enter_button = tk.Button(self.frame3, text="Enter, command = save_grens")
